...
function getTokens() {
  if ($.isNode()) {
    ...
    $.tokenArr = [JSON.parse($.getdata('jxnc_token1') || '{"farm_jstoken":"9e0987e0044eb328431ab5094fa1ac32","phoneid":"376fa19ac4936ebb0590013a445c56c9dcd78070","timestamp":"1613747391175","pin":"jd_5d5c043b0f0ba"}'), JSON.parse($.getdata('jxnc_token2') || '{}')];
  }
  if (!$.tokenArr[0]) {
    $.msg(
      $.name,
